...
export const demoLessons: Lesson[] = [
  { id: 'l1', emoji: '\uD83D\uDCB0', title: 'O que é Renda Fixa?', description: 'Entenda os principais títulos de renda fixa do Brasil.', category: 'beginner', readingTimeMin: 2, content: 'Renda fixa é uma classe de investimentos onde as condições de rentabilidade são definidas no momento da aplicação. Os principais títulos incluem Tesouro Direto (Selic, IPCA+, Prefixado), CDBs, LCIs, LCAs e debêntures. São considerados investimentos mais seguros, ideais para reserva de emergência e objetivos de curto prazo.' },
  { id: 'l2', emoji: '\uD83D\uDCC8', title: 'Introdução à Bolsa', description: 'Como funciona o mercado de ações brasileiro.', category: 'beginner', readingTimeMin: 2, content: 'A B3 (Brasil, Bolsa, Balcão) é a bolsa de valores brasileira. Ao comprar ações, você se torna sócio de empresas. Os ganhos vêm da valorização dos papéis e de dividendos. É importante diversificar e investir com visão de longo prazo. Utilize análise fundamentalista para escolher boas empresas.' },
  { id: 'l3', emoji: '\uD83C\uDFE2', title: 'FIIs - Fundos Imobiliários', description: 'Renda passiva com imóveis sem comprar imóveis.', category: 'beginner', readingTimeMin: 2, content: 'Fundos de Investimento Imobiliário (FIIs) permitem investir em imóveis com pouco dinheiro. Os rendimentos mensais são isentos de IR para pessoa física. Existem FIIs de tijolo (galpões, shoppings, escritórios) e de papel (CRIs, LCIs). São negociados na bolsa como ações.' },
  { id: 'l4', emoji: '\u2696\uFE0F', title: 'Diversificação de Carteira', description: 'Por que não colocar todos os ovos na mesma cesta.', category: 'intermediate', readingTimeMin: 2, content: 'Diversificação reduz o risco da carteira distribuindo investimentos entre diferentes classes de ativos, setores e geografias. A correlação entre ativos é fundamental — ativos com correlação negativa protegem a carteira em momentos de estresse. Uma carteira diversificada pode ter renda fixa, ações, FIIs, cripto e ativos internacionais.' },
  { id: 'l5', emoji: '\uD83E\uDDEE', title: 'Imposto de Renda em Investimentos', description: 'Entenda a tributação de cada tipo de ativo.', category: 'intermediate', readingTimeMin: 2, content: 'Cada classe de ativo tem regras diferentes de IR. Ações: isenção até R$ 20k/mês em vendas, alíquota de 15% sobre ganho (20% para day trade). FIIs: rendimentos isentos, ganho de capital 20%. Renda fixa: tabela regressiva de 22,5% a 15%. Cripto: 15% sobre ganhos acima de R$ 35k/mês. Compense prejuízos para pagar menos imposto.' },
  { id: 'l6', emoji: '\uD83D\uDD25', title: 'FIRE - Independência Financeira', description: 'O movimento para aposentar cedo.', category: 'advanced', readingTimeMin: 2, content: 'FIRE (Financial Independence, Retire Early) é o movimento de acumular patrimônio suficiente para viver de renda passiva. A regra dos 4% sugere que você precisa de 25x suas despesas anuais. Para despesas de R$ 12.000/mês, o número FIRE é R$ 3.600.000. Estratégias incluem aumentar renda, reduzir gastos e investir a diferença.' },
  { id: 'l7', emoji: '\uD83C\uDF0D', title: 'Investimentos Internacionais', description: 'Como e por que investir fora do Brasil.', category: 'advanced', readingTimeMin: 2, content: 'Investir internacionalmente protege contra risco-país e dá acesso a empresas globais. Opções incluem BDRs na B3, ETFs internacionais (IVVB11, NASD11), ou conta em corretora no exterior. Considere a exposição cambial e tributação específica. Recomenda-se 10-30% do portfólio em ativos internacionais.' },
];
