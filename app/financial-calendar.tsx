...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    monthPill: { paddingHorizontal: spacing.sm + 4, paddingVertical: spacing.xs, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border },
    monthText: { fontSize: 12, fontWeight: '600', color: colors.text.secondary },
