  ...
  // ---------------------------------------------------------------------------
  {
    ...
    transactions: [
      ...
      },
      {
        ...
        description: 'Ipiranga - Combustivel',
        category: 'fuel',
        amount: 350.00,
      },
      {
...
export const notifications: Notification[] = [
  {
    ...
    body: 'Voce recebeu R$ 234,50 de revenue share referente a fevereiro.',
  ...
  },
  {
    ...
    body: 'Petrobras PN acumula valorizacao de 35% desde sua compra. Considere realizar lucro parcial.',
  ...
  },
  {
    ...
    body: 'Voce recebeu R$ 612,50 em dividendos do Banco do Brasil (350 acoes x R$ 1,75).',
  ...
  },
  {
    ...
    body: 'Magazine Luiza caiu 38,8% desde sua compra. Avalie se faz sentido manter a posicao.',
  ...
  },
  {
    ...
    body: 'Voce recebeu R$ 82,00 em rendimentos do HGLG11 (100 cotas x R$ 0,82).',
  ...
  },
  {
    ...
    body: 'Sua fatura de R$ 8.320,00 vence em 15/03. Limite disponivel: R$ 11.680,00.',
  ...
  },
  {
    ...
    body: 'Sua autenticacao biometrica foi verificada com sucesso. Conta protegida.',
  ...
  },
  {
    ...
    body: 'Voce recebeu R$ 55,00 em rendimentos do MXRF11 (500 cotas x R$ 0,11).',
  ...
  },
  {
    ...
    body: 'Sua alocacao em renda fixa (65%) esta acima do recomendado (57%). Considere diversificar.',
...
export const insights: Insight[] = [
  ...
  },
  {
    id: 'i2',
    icon: '\u{1F4CA}',
    text: 'Sua alocacao em renda fixa esta 8% acima do recomendado',
    action: 'Rebalancear',
    type: 'info',
  },
  {
