...
export const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    'family.invite': 'Convidar Membro',
    'family.inviteEmail': 'Email do membro',
    'family.role': 'Relação',
    ...
    'family.accepted': 'Ativo',
    'family.create': 'Criar Grupo',
    'family.noGroup': 'Você ainda não tem um grupo familiar',
    'family.createDesc': 'Crie um grupo e convide sua família para consolidar o patrimônio',
    'family.groupName': 'Nome do grupo',
    'family.send': 'Enviar convite',
  ...
  en: {
    ...
    'family.inviteEmail': 'Member email',
    ...
    'family.accepted': 'Active',
    'family.create': 'Create Group',
    'family.noGroup': 'You don\'t have a family group yet',
    'family.createDesc': 'Create a group and invite your family to consolidate wealth',
    'family.groupName': 'Group name',
    'family.send': 'Send invite',
  ...
  zh: {
    ...
    // Family
    'family.title': '家庭组',
    'family.totalWealth': '家庭资产',
    'family.members': '成员',
    'family.invite': '邀请成员',
    'family.inviteEmail': '成员邮箱',
    'family.role': '关系',
    'family.owner': '户主',
    'family.spouse': '配偶',
    'family.child': '子女',
    'family.member': '成员',
    'family.pending': '邀请待处理',
    'family.accepted': '已激活',
    'family.create': '创建组',
    'family.noGroup': '您还没有家庭组',
    'family.createDesc': '创建一个组并邀请您的家人来整合资产',
    'family.groupName': '组名称',
    'family.send': '发送邀请',
  ...
  ar: {
    ...
    // Family
    'family.title': 'المجموعة العائلية',
    'family.totalWealth': 'ثروة العائلة',
    'family.members': 'الأعضاء',
    'family.invite': 'دعوة عضو',
    'family.inviteEmail': 'بريد العضو',
    'family.role': 'العلاقة',
    'family.owner': 'المالك',
    'family.spouse': 'الزوج/ة',
    'family.child': 'الابن/ة',
    'family.member': 'عضو',
    'family.pending': 'دعوة معلقة',
    'family.accepted': 'نشط',
    'family.create': 'إنشاء مجموعة',
    'family.noGroup': 'ليس لديك مجموعة عائلية بعد',
    'family.createDesc': 'أنشئ مجموعة وادعُ عائلتك لتوحيد الثروة',
    'family.groupName': 'اسم المجموعة',
    'family.send': 'إرسال دعوة',
