...
const ICON_MAP: Record<string, { lib: 'ion' | 'mci'; name: string; emoji: string }> = {
  ...
  'star-outline': { lib: 'ion', name: 'star-outline', emoji: '\u2606' },
  'star-filled': { lib: 'ion', name: 'star', emoji: '\u2B50' },
  sync:          { lib: 'ion', name: 'sync-outline', emoji: '\uD83D\uDD04' },
  ...
  netWorth:     { lib: 'ion', name: 'trending-up-outline', emoji: '\uD83D\uDCCA' },
  debt:         { lib: 'mci', name: 'credit-card-minus-outline', emoji: '\uD83D\uDCB3' },
  ...
  diary:        { lib: 'ion', name: 'journal-outline', emoji: '\uD83D\uDCD4' },
  compound:     { lib: 'ion', name: 'calculator-outline', emoji: '\uD83E\uDDEE' },
