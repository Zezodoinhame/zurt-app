...
import { ALL_CURRENCIES, CURRENCY_SYMBOLS } from '../src/utils/currencyRates';
...
export default function CurrencyConverterScreen() {
  ...
  const { amount, from, to, convertedAmount, rate, rateHistory, crossRates, setAmount, setFrom, setTo, swap } = useCurrencyConverterStore();
